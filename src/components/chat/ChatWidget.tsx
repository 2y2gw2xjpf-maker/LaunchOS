        ...
        {!isOpen && (
          <motion.button
            ...
            className={cn(
              ...
              // Mobile: above bottom nav with safe area consideration
              'right-4',
            ...
            style={{
              // Mobile: position above nav bar (nav is ~60px + safe area)
              bottom: 'max(calc(68px + env(safe-area-inset-bottom, 0px)), 68px)',
            }}
          >
        ...
        {isOpen && (
          <motion.div
            ...
            className={cn(
              ...
              'max-h-[60vh] md:h-auto md:max-h-[85vh]',
