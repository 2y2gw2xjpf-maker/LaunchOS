      ...
      <div className="flex h-screen bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Tools werden geladen...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-bold text-gray-900">AI-Coding Tools</h1>
              </div>
                  ...
                  <div className="p-6">
                    ...
                    {tool.bestFor && tool.bestFor.length > 0 && (
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <p className="text-xs font-medium text-gray-500 mb-2">Ideal für:</p>
            ...
            {filteredTools.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Keine Tools gefunden</h3>
                <p className="text-gray-500">
            ...
            {tools.length > 0 && (
              <section className="mt-12">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Vergleichs-Übersicht</h2>
                <div className="bg-white rounded-2xl border border-purple-100 overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-100">
                        <th className="px-6 py-4 text-left text-sm font-medium text-gray-500">Tool</th>
                        {Object.entries(RATING_LABELS).map(([key, { label, icon: Icon }]) => (
                          <th key={key} className="px-4 py-4 text-center text-sm font-medium text-gray-500">
